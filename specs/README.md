...
| 5 | DesktopWorld (5a + 5b) | 4 Work Specs **Draft** (2026-06-28) | [`Phase-5-DesktopWorld/overview.md`](Phase-5-DesktopWorld/overview.md) | Apple-Style + 4-category for `spec-001..spec-004`. **5a Discover + Render-Route Decision-tree locked per D-005**. **5b Container + NavMesh + AnimationDriver implementation — D-007 cross-deliverable** (Phase-4 was signature-only; Phase-5 fills body). Cumulative Phase-5 memory budget ≤ 12 MB delta on Phase-4 baseline (≤ **154 MB** worst-case at end-of-Phase-5). |
| 6 | Behavior | 7 Work Specs **Draft** (2026-06-28) | [`Phase-6-Behavior/overview.md`](Phase-6-Behavior/overview.md) | Apple-Style + 4-category for spec-001..spec-007. **Mandatory Privacy Spec** in `spec-006` (default-deny boundary guard); **D-006 cross-deliverable stub half** in `spec-007` (Phase-7 fills real Skill Runtime). Cumulative Phase-6 memory budget ≤ 4 MB delta on Phase-5 baseline (≤ **158 MB** worst-case). |
| 7 | AI | 8 Work Specs **Draft** (2026-06-28) | [`Phase-7-AI/overview.md`](Phase-7-AI/overview.md) | Apple-Style + 4-category for spec-001..spec-008. **D-006 cross-deliverable**: Phase-6 Skill stub → Phase-7 real Skill Runtime. **Mandatory Failure Mode Matrix** in `spec-008`: ≥ 5 modes (network / token / 5xx / permission / parse). Cumulative Phase-7 memory budget ≤ 8 MB delta on Phase-6 baseline (≤ **166 MB** worst-case). |
| 8 | Hardening | 6 Work Specs **Draft** (2026-06-28) | [`Phase-8-Hardening/overview.md`](Phase-8-Hardening/overview.md) | Apple-Style + 4-category for spec-001..spec-006. **Memory Audit flagship**: 166 MB → **≤ 98 MB** target (−68 MB). Frame scheduler / CPU / GPU / battery / installer. Cumulative Phase-8 memory ceiling 98 MB (visual diff ≤ 1 % MSE; cache hit-rate ≥ 70 %). |
| 9 | Beta | 5 Work Specs **Draft** (2026-06-28) (3 must-ship + 2 may-defer) | [`Phase-9-Beta/overview.md`](Phase-9-Beta/overview.md) | Apple-Style + 4-category for spec-001..spec-005. **D-011 split**: Reliability (Auto Update / Crash Report / Telemetry) must ship; Ecosystem (Plugin SDK / Skill Marketplace) may defer to v1.1 if Acceptance cannot be met. Cumulative Phase-9 ≤ 4 MB (Reliability only, ≤ 102 MB) or ≤ 6 MB (full ship, ≤ 108 MB). |

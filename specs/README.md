...
| 6 | Behavior | 7 Work Specs **Draft** (2026-06-28) | [`Phase-6-Behavior/overview.md`](Phase-6-Behavior/overview.md) | Apple-Style + 4-category for spec-001..spec-007. **Mandatory Privacy Spec** in `spec-006` (default-deny boundary guard); **D-006 cross-deliverable stub half** in `spec-007` (Phase-7 fills real Skill Runtime). Cumulative Phase-6 memory budget ≤ 4 MB delta on Phase-5 baseline (≤ 164 MB worst-case). |
| 7 | AI | 8 Work Specs **Draft** (2026-06-28) | [`Phase-7-AI/overview.md`](Phase-7-AI/overview.md) | Apple-Style + 4-category for spec-001..spec-008. **D-006 cross-deliverable**: Phase-6 Skill stub → Phase-7 real Skill Runtime. **Mandatory Failure Mode Matrix** in `spec-008`: ≥ 5 modes (network / token / 5xx / permission / parse). Cumulative Phase-7 memory budget ≤ 8 MB delta on Phase-6 baseline (≤ 168 MB worst-case). |
| 8 | Hardening | 6 Work Specs **Draft** (2026-06-28) | [`Phase-8-Hardening/overview.md`](Phase-8-Hardening/overview.md) | Apple-Style + 4-category for spec-001..spec-006. **Memory Audit flagship**: 168 MB → < 100 MB target (−68 MB). Frame scheduler / CPU / GPU / battery / installer. Cumulative Phase-8 memory ceiling 100 MB (visual diff ≤ 1 % MSE; cache hit-rate ≥ 70 %). |
